export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: 'Vincula necesita saber cuándo ocurre una compra para enviar el email de review. La conexión se hace una sola vez.',
    ...
    },
    {
      number: '03',
      icon: '📈',
      title: 'Los reviews llegan solos',
      description: 'Una vez configurado, cada orden completada dispara el email de review automáticamente. Tú no haces nada más.',
      detail: 'Desde el dashboard ves cuántos reviews llegaron, tu rating actual y la tasa de respuesta de tus emails.',
      color: '#ede9fe',
      textColor: '#4c1d95',
    },
  ]
