  ...
  const steps = [
    {
      number: '01',
      icon: '⚡',
      title: 'Pegá una línea de código',
      description: 'Instalá el widget en tu tienda igual que Google Analytics. Sin programación, sin complicaciones.',
      detail: 'Copiá el snippet y pegalo en el <head> de tu tienda. Funciona en cualquier plataforma.',
      color: '#dbeafe',
      textColor: '#1e40af',
    },
    {
      number: '02',
      icon: '⚙️',
      title: 'Configurá en el dashboard',
      description: 'Personalizá los emails, el diseño del widget y tus preferencias desde un panel simple e intuitivo.',
    ...
    },
    {
      number: '03',
      icon: '📈',
      title: 'Empezá a convertir',
      description: 'Mirá en tiempo real los reviews nuevos, los carritos recuperados y el impacto en tus ventas.',
      detail: 'Métricas claras, sin datos basura. Sabés exactamente cuánto dinero te está generando Vincula.',
      color: '#ede9fe',
      textColor: '#4c1d95',
    },
  ]
