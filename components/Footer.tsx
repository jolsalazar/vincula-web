        ...
        <div className="container">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <div className="footer-social">
                ...
                <a href="https://wa.me/message/ouivi" className="footer-social-link" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div>
              ...
              <ul className="footer-links" role="list">
                ...
                <li>
                  <a href="https://wa.me/message/ouivi" target="_blank" rel="noopener noreferrer">
                    WhatsApp
          ...
          <div className="footer-bottom">
            <p className="footer-copy">
              Hecho con <span className="footer-heart">❤️</span> para el ecommerce · ouivi.io · {year}
            </p>
