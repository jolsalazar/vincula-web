        ...
        <div className="container">
          <div className="footer-top">
            <div className="footer-brand">
              <a href="#" className="footer-logo" aria-label={`${BRAND.siteName} inicio`}>
              ...
              <div className="footer-social">
                ...
                <a href={BRAND.whatsapp} className="footer-social-link" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-bottom">
            <p className="footer-copy">
              Hecho con <span className="footer-heart">❤️</span> para el ecommerce · {BRAND.domain} · {year}
            </p>
